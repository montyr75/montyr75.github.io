(function ($) {
    ...
    function getAliasFromId(id) {
        for(var i in aliases) {
            if(aliases.hasOwnProperty(i) && aliases[i] === id) {
                return i;
            }
        }
        return null;
    ...
    $.fn.extend({
        popup:function (options) {
            ...
            this.open = function () {
                ...
                if (popups && o.group in popups && o.appendTo in popups[o.group] && o.groupDepth in popups[o.group][o.appendTo]) {// if they have an index specified. it removes all items higher than that index.
                    var index = o.groupDepth;
                    var g = popups[o.group];
                    while (o.appendTo in g && g[o.appendTo].length > index) {
                ...
                if (popups[o.group][o.appendTo].indexOf(id) === -1) {
                    ...
                    if (o.modal) {// one modal for each popup.
                        var modal = $('<div class="popupModal '+popupPrefix+popupId+'" style="position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:' + o.zIndex + '"></div>');// popup container
                        if(o.modalClass) {
                            ...
                            modal.bind('click', function (evt) {
                                if(o.modalAutoClose) {
                                    ...
                                    if(f) {
                                        ...
                                        f($('#'+id));// call the function after it has been removed.
                                    }
                                }
                            });
                        }
        ...
        if (popupOptions) {
            ...
            if (popupOptions.hasOwnProperty(id)) {
                ...
                if (o.onClose) {// if they still have an onClose. Call that.
                    ...
                    var waitForRecall = f($('#' + id));// call the function after it has been removed.
                    if(waitForRecall) {
                        return;
                    }
                }
                ...
                if (popupOptions && popupOptions.hasOwnProperty(id)) {
                    ...
                    var modal = el.parent().children('.popupModal.'+id);
                    el.remove();
                    if (modal.length) {
                        modal.remove();
                    }
